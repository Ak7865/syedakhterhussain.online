...
export const alt =
  "Syed Akhter Hussain — Full Stack Web Developer, Nagaon, Assam";
    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(88,166,255,0.15) 0%, transparent 70%)",
          display: "flex",
        }}
      />
      <div
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
            ...
            <div style={{ fontSize: "24px", fontWeight: 600, display: "flex" }}>
              ...
              <span style={{ color: "#8b949e", marginLeft: "10px" }}>
      ...
      >
        ...
        <span style={{ color: "#3fb950", fontSize: "14px", display: "flex" }}>
          github.com/Ak7865 · 8bitbannar.in
        </span>
      </div>
    </div>,
    { ...size },
