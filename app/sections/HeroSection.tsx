    ...
    const draw = () => {
      ...
      for (let i = 0; i < N; i++) {
        for (let j = i + 1; j < N; j++) {
          ...
          if (d < 130) {
            ...
            ctx.strokeStyle = `rgba(48,54,61,${(1 - d / 130) * 0.7})`;
            ctx.lineWidth = 0.5;
            ctx.stroke();
          }
        }
      ...
      pts.forEach((p) => {
        ...
        if (d < 150) {
          ...
          ctx.moveTo(p.x, p.y);
          ctx.lineTo(hx, hy);
          ctx.strokeStyle = `rgba(63,185,80,${(1 - d / 150) * 0.3})`;
          ctx.lineWidth = 0.7;
          ctx.stroke();
        }
        ctx.beginPath();
        ctx.arc(p.x, p.y, p.r, 0, Math.PI * 2);
        ctx.fillStyle = `rgba(139,148,158,${p.a})`;
        ctx.fill();
        p.x += p.vx;
        p.y += p.vy;
      ...
      >
        <div>
          ...
          >
            <a
              ...
              onMouseEnter={(e) => {
                ...
                t.style.background = "#4ac661";
                t.style.boxShadow = "0 0 24px var(--glow-green)";
          ...
          <div
            style={{
              ...
              gap: "28px",
              marginTop: "40px",
              animation: "fadeUp 0.6s ease both 0.8s",
            }}
          >
        ...
        >
          ...
          {[
            {
              label: "⚛️ React.js",
              style: { top: "14%", left: "-55px", animationDelay: "0s" },
            },
            {
              label: "🔥 Firebase",
              style: { top: "46%", right: "-45px", animationDelay: "0.8s" },
            },
            {
              label: "🐘 PHP",
              style: { bottom: "18%", left: "-48px", animationDelay: "1.6s" },
            },
          ].map((p) => (
            <div
              key={p.label}
