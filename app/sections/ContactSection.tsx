...
export default function ContactSection() {
  ...
  const LINKS = [
    ...
    },
    {
      icon: "🐱",
      title: "GitHub",
      sub: "github.com/Ak7865",
      href: personal.github,
    },
    {
      icon: "🌐",
      title: "Portfolio",
      sub: "syedakhterhussain.online",
      href: personal.portfolio,
    },
    {
      icon: "🏢",
      title: "8BitBannar",
      sub: "8bitbannar.in — WebTech Company",
  ...
  return (
    ...
    >
      <div className="section-inner">
        ...
        >
          Have a project, freelance opportunity, or just want to say hi? I
        ...
        >
          ...
          >
            {[
              ...
              },
              {
                ...
                label: "Subject",
                type: "text",
                placeholder: "Project, freelance, or just saying hi",
              },
          ...
          >
            ...
            >
              ...
              <br />⏰ Reply time:{" "}
              <strong style={{ color: "var(--green)" }}>within 24 hours</strong>
              <br />
              💬 Open to:{" "}
              <strong style={{ color: "var(--text-primary)" }}>
