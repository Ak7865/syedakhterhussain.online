...
export const personal = {
  ...
  tagline: 'B.Tech CSE student building scalable web apps with React, PHP, Node.js & Firebase.',
  bio: [
  ...
  quote: '"Transforming complex challenges into intuitive solutions through clean, maintainable code."',
  ...
  tags: ['Full Stack', 'React Learner', 'PHP/MySQL', 'Firebase', 'Freelancer', '8BitBannar', 'B.Tech CSE', 'MERN Stack'],
}

export const story = [
  { num: '01', icon: '🎮', title: 'The Curiosity', desc: "Growing up in Nagaon, Assam — I was always the kid who wanted to know how things worked. That curiosity led me to computers." },
  { num: '02', icon: '🎓', title: 'The Foundation', desc: "Diploma in CSE at Nalbari Polytechnic, then B.Tech at Barak Valley Engineering College. Theory met practice — and I loved every minute." },
  { num: '03', icon: '💻', title: 'The Build', desc: "Built a Timetable Management System for my college, a Real-Time Chat App, an E-Commerce platform — each project leveled me up." },
  { num: '04', icon: '🌐', title: '8BitBannar', desc: "Founded 8BitBannar — a WebTech company in Assam, offering professional development, maintenance & design services." },
]
...
export const githubRepos = [
  { name: 'timetable-management-system', desc: 'Automated scheduling system for Nalbari Polytechnic. PHP/MySQL backend.', lang: 'PHP' },
  { name: 'react-firebase-chat', desc: 'Real-time chat app with Firebase authentication and Firestore messaging.', lang: 'JavaScript' },
  { name: 'ecommerce-php', desc: 'Full-stack e-commerce platform with cart and payment integration.', lang: 'PHP' },
  { name: 'portfolio-v2', desc: 'Personal portfolio — deployed on Vercel. HTML/CSS/JS + SEO optimized.', lang: 'JavaScript' },
]

export const services = [
  { icon: '🎨', title: 'Web Design', desc: 'Visually appealing, responsive, user-centric website designs using HTML5, CSS3 and modern UI/UX practices. Mobile-first on every project.' },
  { icon: '⚙️', title: 'Website Maintenance', desc: 'Reliable ongoing support to keep your website updated, secure and optimized. Regular backups, performance checks and content updates.' },
  { icon: '💼', title: 'Freelance Projects', desc: 'Available for freelance engagements — from static portfolio sites to full e-commerce platforms. Transparent pricing for Assam-based clients.' },
  { icon: '🚀', title: 'Web App Development', desc: 'Dynamic, database-driven web applications using React, PHP, Node.js, Firebase and Supabase. Scalable architecture from day one.' },
  { icon: '🤝', title: 'Collaboration', desc: 'Open to collaborate on group projects, GitHub-based development and open-source initiatives. Happy to pair program and learn together.' },
  { icon: '📱', title: 'Responsive Design', desc: 'Every site works flawlessly on mobile, tablet and desktop. Tested across devices and browsers before delivery.' },
]

export const chatKB: Record<string, string> = {
  stack: "Syed works with HTML5, CSS3, JavaScript, PHP, React (learning), Node.js, MySQL, Firebase, and Supabase. He codes in Java and Python too.",
  ...
  project: "Key projects: ✅ Timetable System (PHP/MySQL), 💬 Real-Time Chat App (React/Firebase), 🛒 E-Commerce Platform, and 🌐 8BitBannar site.",
  '8bitbannar': "8BitBannar (8bitbannar.in) is Syed's own WebTech company in Assam. It offers web design, development, maintenance and app services.",
  education: "B.Tech CSE at Barak Valley Engineering College (2024–present). Diploma CSE from Nalbari Polytechnic (2020–2023).",
  certification: "He holds 8 certifications: AI-ML (NIT Silchar), Web Dev (Internshala), Networking (TRTC Guwahati), Game Dev (GUVI×IITM), Java (Great Learning), Full Stack (Prodigy Infotech), Data Entry (MSME Skill India).",
  contact: "📧 ah076145@gmail.com | 📱 +91-9127222171 | Based in Nagaon, Assam 782003.",
  language: "Syed speaks 4 languages: English, Assamese, Hindi and Bengali — great for working across India!",
}